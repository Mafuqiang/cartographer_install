...
class Node {
 ...
 private:
  ...
  //added by mafuqiang: get the dynamic map;
    ...
    : resolution_(resolution),
      ...
      occupancy_grid_publisher_timer_(
          node_handle_.createWallTimer(::ros::WallDuration(publish_period_sec),
                                       ...
                                       {
    map_service = node_handle_.advertiseService("dynamic_map", &Node::mapCallback, this);

}

bool Node::mapCallback(nav_msgs::GetMap::Request &req, nav_msgs::GetMap::Response &res){
