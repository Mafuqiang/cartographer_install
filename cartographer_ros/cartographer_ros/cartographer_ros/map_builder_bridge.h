...
class MapBuilderBridge {
 public:
  ...
  /*
   * added by mafuqiang: reset the class Mapbuilder when restart the service of "start_create_map" of node;
   */
  void ResetMapbuilder(std::unique_ptr<cartographer::mapping::MapBuilderInterface> new_map_builder);
  /*
   * added end;
   */
