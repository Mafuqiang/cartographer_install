...
constexpr char kOccupancyGridTopic[] = "create/map";
...
/*
 * added by mafuqiang: start to create map, finish to create map, and start localization with relocation;
 */
constexpr char kStartCreateMapServiceName[] = "start_create_map";
constexpr char kFinishCreateMapServiceName[] = "finish_create_map";
constexpr char kStartLocalizationServiceName[] = "start_localization";
constexpr char kStartLocalizationFromPbstreamServiceName[] = "start_localization_from_pbstream";
constexpr char kFinishLocalizationServiceName[] = "finish_localization";
/*
 * added end;
 */
