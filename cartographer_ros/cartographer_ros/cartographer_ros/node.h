...
class Node {
 public:
  ...
  //added by mafuqiang: set the trajectory options; set the directory and filename of create map;
  // set the filename of localization;
  void SetTrajectoryOptions(TrajectoryOptions& trajectory_options);
  void SetDirectoryAndBasename(std::string &directory, std::string &basename, std::string &basename_localization);
  void SetLoadStateFilename(std::string &filename, bool frozen_state = true);
  //added end;
 ...
 private:
  ...
  //added by mafuqiang;
  bool HandleEmptyService(
          std_srvs::Empty::Request& request,
          std_srvs::Empty::Response& response);

  bool HandleStartCreateMap(
          std_srvs::Empty::Request& request,
          std_srvs::Empty::Response& response);

  bool HandleFinishCreateMap(
          std_srvs::Empty::Request& request,
          std_srvs::Empty::Response& response);
  ...
  bool HandleStartLocalizationFromPbstream(
          std_srvs::Empty::Request& request,
          std_srvs::Empty::Response& response);

  bool HandleFinishLocalization(
          std_srvs::Empty::Request& request,
          std_srvs::Empty::Response& response);
  ...
  //added by mafuqiang: the options of trajectory;
  std::string configuration_directory;
  std::string configuration_basename;
  std::string configuration_basename_localization;

  std::string load_state_filename;
  bool load_frozen_state;

  TrajectoryOptions trajectory_options_mafuqiang;

  int create_map_trajectory_id;
  int localization_trajectory_id;

  bool start_create_map_controller;
  //added end;
