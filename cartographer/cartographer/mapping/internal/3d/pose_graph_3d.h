...
class PoseGraph3D : public PoseGraph {
 public:
  ...
  transform::Rigid3d GetInterpolatedGlobalTrajectoryPose(
    ...
    //added by mafuqiang;
//    float GetRelocationMaxScore() override ;
//    float GetRelocationMinScore() override ;
//    int GetAllRelocationNum() override ;
//    int GetRelocationSuccessNum() override ;
  RelocationResult GetRelocationResult() override;
