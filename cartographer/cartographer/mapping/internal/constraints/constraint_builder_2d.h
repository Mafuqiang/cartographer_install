...
//    static float purge_localization_score = -1.;

//    static float max_score = 0.;
//
//    static float min_score = 0.;
//
//    static float mean_score = 0.;

//    static int relocation_num = 0;
//
//    static int successed_num = 0;
//
//    static float getPurgeLocalizationMatchScore(){return purge_localization_score;}
//
//    static int GetRelocationNum(){return relocation_num;}
//
//    static int GetSuccessedNum(){return successed_num;}
...
//        int successed_num;
//    };
  using RelocationResult = PoseGraphInterface::RelocationResult;
  ...
  static void RegisterMetrics(metrics::FamilyFactory* family_factory);
    ...
    //added by mafuqiang;
    RelocationResult GetRelocationResult();

//  int GetRelocationNum();
//
//  int GetSuccessedNum();
//
//  float GetRelocationMaxScore();
//
//  float GetRelocationMinScore();
