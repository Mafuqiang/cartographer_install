...
//  //added by mafuqiang;
//  virtual float GetRelocationMaxScore() = 0;
//  virtual float GetRelocationMinScore() = 0;
//  virtual int GetAllRelocationNum() = 0;
//  virtual int GetRelocationSuccessNum() = 0;
  virtual RelocationResult GetRelocationResult() = 0;
